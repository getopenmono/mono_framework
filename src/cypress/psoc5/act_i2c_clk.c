...
*
* \funcusage
*  \snippet act_i2c_clk_SUT.c usage_act_i2c_clk_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet act_i2c_clk_SUT.c usage_act_i2c_clk_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet act_i2c_clk_SUT.c usage_act_i2c_clk_Read  
*******************************************************************************/
...
* preferred act_i2c_clk_Read() API because the 
* act_i2c_clk_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet act_i2c_clk_SUT.c usage_act_i2c_clk_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: act_i2c_clk_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use act_i2c_clk_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - act_i2c_clk_0_INTR       (First pin in the list)
    *  - act_i2c_clk_1_INTR       (Second pin in the list)
    *  - ...
    *  - act_i2c_clk_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet act_i2c_clk_SUT.c usage_act_i2c_clk_SetInterruptMode
    *******************************************************************************/
    void act_i2c_clk_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & act_i2c_clk_0_INTR) != 0u) 
		{ 
			 act_i2c_clk_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet act_i2c_clk_SUT.c usage_act_i2c_clk_ClearInterrupt
    *******************************************************************************/
