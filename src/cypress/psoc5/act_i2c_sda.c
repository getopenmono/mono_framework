...
*
* \funcusage
*  \snippet act_i2c_sda_SUT.c usage_act_i2c_sda_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet act_i2c_sda_SUT.c usage_act_i2c_sda_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet act_i2c_sda_SUT.c usage_act_i2c_sda_Read  
*******************************************************************************/
...
* preferred act_i2c_sda_Read() API because the 
* act_i2c_sda_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet act_i2c_sda_SUT.c usage_act_i2c_sda_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: act_i2c_sda_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use act_i2c_sda_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - act_i2c_sda_0_INTR       (First pin in the list)
    *  - act_i2c_sda_1_INTR       (Second pin in the list)
    *  - ...
    *  - act_i2c_sda_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet act_i2c_sda_SUT.c usage_act_i2c_sda_SetInterruptMode
    *******************************************************************************/
    void act_i2c_sda_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & act_i2c_sda_0_INTR) != 0u) 
		{ 
			 act_i2c_sda_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet act_i2c_sda_SUT.c usage_act_i2c_sda_ClearInterrupt
    *******************************************************************************/
