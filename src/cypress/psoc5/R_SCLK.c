...
*
* \funcusage
*  \snippet R_SCLK_SUT.c usage_R_SCLK_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet R_SCLK_SUT.c usage_R_SCLK_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet R_SCLK_SUT.c usage_R_SCLK_Read  
*******************************************************************************/
...
* preferred R_SCLK_Read() API because the 
* R_SCLK_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet R_SCLK_SUT.c usage_R_SCLK_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: R_SCLK_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use R_SCLK_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - R_SCLK_0_INTR       (First pin in the list)
    *  - R_SCLK_1_INTR       (Second pin in the list)
    *  - ...
    *  - R_SCLK_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet R_SCLK_SUT.c usage_R_SCLK_SetInterruptMode
    *******************************************************************************/
    void R_SCLK_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & R_SCLK_0_INTR) != 0u) 
		{ 
			 R_SCLK_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet R_SCLK_SUT.c usage_R_SCLK_ClearInterrupt
    *******************************************************************************/
