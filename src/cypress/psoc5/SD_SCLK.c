...
*
* \funcusage
*  \snippet SD_SCLK_SUT.c usage_SD_SCLK_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet SD_SCLK_SUT.c usage_SD_SCLK_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet SD_SCLK_SUT.c usage_SD_SCLK_Read  
*******************************************************************************/
...
* preferred SD_SCLK_Read() API because the 
* SD_SCLK_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet SD_SCLK_SUT.c usage_SD_SCLK_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: SD_SCLK_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use SD_SCLK_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - SD_SCLK_0_INTR       (First pin in the list)
    *  - SD_SCLK_1_INTR       (Second pin in the list)
    *  - ...
    *  - SD_SCLK_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet SD_SCLK_SUT.c usage_SD_SCLK_SetInterruptMode
    *******************************************************************************/
    void SD_SCLK_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & SD_SCLK_0_INTR) != 0u) 
		{ 
			 SD_SCLK_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet SD_SCLK_SUT.c usage_SD_SCLK_ClearInterrupt
    *******************************************************************************/
