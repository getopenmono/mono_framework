...
*
* \funcusage
*  \snippet TFT_LED_PWR_SUT.c usage_TFT_LED_PWR_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet TFT_LED_PWR_SUT.c usage_TFT_LED_PWR_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet TFT_LED_PWR_SUT.c usage_TFT_LED_PWR_Read  
*******************************************************************************/
...
* preferred TFT_LED_PWR_Read() API because the 
* TFT_LED_PWR_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet TFT_LED_PWR_SUT.c usage_TFT_LED_PWR_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: TFT_LED_PWR_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use TFT_LED_PWR_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - TFT_LED_PWR_0_INTR       (First pin in the list)
    *  - TFT_LED_PWR_1_INTR       (Second pin in the list)
    *  - ...
    *  - TFT_LED_PWR_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet TFT_LED_PWR_SUT.c usage_TFT_LED_PWR_SetInterruptMode
    *******************************************************************************/
    void TFT_LED_PWR_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & TFT_LED_PWR_0_INTR) != 0u) 
		{ 
			 TFT_LED_PWR_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet TFT_LED_PWR_SUT.c usage_TFT_LED_PWR_ClearInterrupt
    *******************************************************************************/
