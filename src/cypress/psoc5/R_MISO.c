...
*
* \funcusage
*  \snippet R_MISO_SUT.c usage_R_MISO_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet R_MISO_SUT.c usage_R_MISO_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet R_MISO_SUT.c usage_R_MISO_Read  
*******************************************************************************/
...
* preferred R_MISO_Read() API because the 
* R_MISO_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet R_MISO_SUT.c usage_R_MISO_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: R_MISO_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use R_MISO_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - R_MISO_0_INTR       (First pin in the list)
    *  - R_MISO_1_INTR       (Second pin in the list)
    *  - ...
    *  - R_MISO_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet R_MISO_SUT.c usage_R_MISO_SetInterruptMode
    *******************************************************************************/
    void R_MISO_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & R_MISO_0_INTR) != 0u) 
		{ 
			 R_MISO_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet R_MISO_SUT.c usage_R_MISO_ClearInterrupt
    *******************************************************************************/
