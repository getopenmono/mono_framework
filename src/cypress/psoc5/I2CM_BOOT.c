...
*
* Global variables:
*  I2CM_slWriteBuf - The global variable used to store a received
*                                command.
*  I2CM_slReadBuf -  The global variable used to store a response.
...
*
* Global variables:
*  I2CM_slWriteBuf - The global variable used to store a
*                                received command.
*
*******************************************************************************/
