...
*
* \funcusage
*  \snippet TFT_MOSI_SUT.c usage_TFT_MOSI_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet TFT_MOSI_SUT.c usage_TFT_MOSI_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet TFT_MOSI_SUT.c usage_TFT_MOSI_Read  
*******************************************************************************/
...
* preferred TFT_MOSI_Read() API because the 
* TFT_MOSI_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet TFT_MOSI_SUT.c usage_TFT_MOSI_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: TFT_MOSI_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use TFT_MOSI_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - TFT_MOSI_0_INTR       (First pin in the list)
    *  - TFT_MOSI_1_INTR       (Second pin in the list)
    *  - ...
    *  - TFT_MOSI_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet TFT_MOSI_SUT.c usage_TFT_MOSI_SetInterruptMode
    *******************************************************************************/
    void TFT_MOSI_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & TFT_MOSI_0_INTR) != 0u) 
		{ 
			 TFT_MOSI_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet TFT_MOSI_SUT.c usage_TFT_MOSI_ClearInterrupt
    *******************************************************************************/
