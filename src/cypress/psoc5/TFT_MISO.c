...
*
* \funcusage
*  \snippet TFT_MISO_SUT.c usage_TFT_MISO_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet TFT_MISO_SUT.c usage_TFT_MISO_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet TFT_MISO_SUT.c usage_TFT_MISO_Read  
*******************************************************************************/
...
* preferred TFT_MISO_Read() API because the 
* TFT_MISO_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet TFT_MISO_SUT.c usage_TFT_MISO_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: TFT_MISO_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use TFT_MISO_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - TFT_MISO_0_INTR       (First pin in the list)
    *  - TFT_MISO_1_INTR       (Second pin in the list)
    *  - ...
    *  - TFT_MISO_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet TFT_MISO_SUT.c usage_TFT_MISO_SetInterruptMode
    *******************************************************************************/
    void TFT_MISO_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & TFT_MISO_0_INTR) != 0u) 
		{ 
			 TFT_MISO_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet TFT_MISO_SUT.c usage_TFT_MISO_ClearInterrupt
    *******************************************************************************/
