...
*
* \funcusage
*  \snippet R_CS_SUT.c usage_R_CS_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet R_CS_SUT.c usage_R_CS_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet R_CS_SUT.c usage_R_CS_Read  
*******************************************************************************/
...
* preferred R_CS_Read() API because the 
* R_CS_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet R_CS_SUT.c usage_R_CS_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: R_CS_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use R_CS_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - R_CS_0_INTR       (First pin in the list)
    *  - R_CS_1_INTR       (Second pin in the list)
    *  - ...
    *  - R_CS_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet R_CS_SUT.c usage_R_CS_SetInterruptMode
    *******************************************************************************/
    void R_CS_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & R_CS_0_INTR) != 0u) 
		{ 
			 R_CS_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet R_CS_SUT.c usage_R_CS_ClearInterrupt
    *******************************************************************************/
