...
*
* \funcusage
*  \snippet R_MOSI_SUT.c usage_R_MOSI_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet R_MOSI_SUT.c usage_R_MOSI_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet R_MOSI_SUT.c usage_R_MOSI_Read  
*******************************************************************************/
...
* preferred R_MOSI_Read() API because the 
* R_MOSI_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet R_MOSI_SUT.c usage_R_MOSI_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: R_MOSI_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use R_MOSI_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - R_MOSI_0_INTR       (First pin in the list)
    *  - R_MOSI_1_INTR       (Second pin in the list)
    *  - ...
    *  - R_MOSI_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet R_MOSI_SUT.c usage_R_MOSI_SetInterruptMode
    *******************************************************************************/
    void R_MOSI_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & R_MOSI_0_INTR) != 0u) 
		{ 
			 R_MOSI_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet R_MOSI_SUT.c usage_R_MOSI_ClearInterrupt
    *******************************************************************************/
